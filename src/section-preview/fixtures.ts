...
export const SECTION_PREVIEW_FIXTURES: SectionPreviewFixture[] = [
  ...
  fixture({ id:"pulse-recovery", archetypes:["sport","wellness"], name:"Pulse", title:"Recovery Daily", description:"La formule quotidienne pensée pour mieux récupérer et retrouver ton rythme dès le lendemain.", price:39, compareAtPrice:49, colors:["#E9F0E7","#FCFFF9","#132016","#79B96A"], fonts:["Space Grotesk","Inter"], images:["photo-1593095948071-474c5cc2989d","photo-1517836357463-d25dfeac3438","photo-1538805060514-97d9cc17730c"], benefits:["Une dose simple après l’effort.","Des ingrédients clairement expliqués.","Un format pensé pour trente jours."], faqs:["Quand prendre la formule ?","Que contient-elle ?","Convient-elle à tous les sports ?"] }),
