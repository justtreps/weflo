...
async function start() {
  ...
  let history = await api<History>("/api/studio/generations").catch(() => ({ generations: [] })); let model: ImageModelId = "nano-banana-2"; let ratio: ImageAspectRatio = "1:1"; let count = 1; let referenceUrl: string | null = null; let insertUrl = ""; let pending: { prompt: string; model: ImageModelId; aspectRatio: ImageAspectRatio } | null = null;
