...
import type { ShopifyCapabilityReport } from "../../shopify/capability-report";

export type PublishOptions = { pro: boolean; documentVersion?: number; capabilityReport?: ShopifyCapabilityReport; shopify: { connected: boolean; shopDomain: string | null; themes: Array<{ id: string; name: string; role: string }> } };
