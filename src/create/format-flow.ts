...
const templateDetails: Record<string, TemplateDetails> = {
  ...
  "product-buybox-premium": { name: "Buy box premium", description: "Une fiche produit détaillée avec une offre claire.", artProfile: "conversion", sectionVariants: { productMain: "premium", reviews: "featured" } },
  ...
  "product-bundle-first": { name: "Bundle first", description: "Une fiche qui met les packs et quantités en avant.", artProfile: "conversion", sectionVariants: { productMain: "bundle-led", bundle: "quantity-break" } },
  "landing-direct-response": { name: "Direct response", description: "Une page de campagne focalisée sur une action.", artProfile: "conversion", sectionVariants: { hero: "direct-response", cta: "repeated" } },
  ...
  "home-brand-editorial": { name: "Brand editorial", description: "Une vitrine de marque riche en histoire et en collections.", artProfile: "editorial", sectionVariants: { hero: "editorial", imageText: "brand-story" } },
  ...
  "home-story-first": { name: "Story first", description: "Une page d’accueil qui présente d’abord le récit de marque.", artProfile: "editorial", sectionVariants: { hero: "story", richText: "manifesto" } },
