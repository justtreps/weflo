...
export function renderCreationsView(model: DashboardHomeModel): string {
  return `<div class="workspace-shell">
    ...
    <main class="creations-main"><header><div><p class="eyebrow">BIBLIOTHÈQUE</p><h1>Mes créations</h1><p>Retrouve, prévisualise et publie toutes tes pages.</p></div><a class="primary-cta" href="/creer">＋ Nouvelle création</a></header>
      ...
      <section class="creation-grid" data-creation-grid>${model.projects.length ? model.projects.map(card).join("") : `<a class="creation-empty" href="/creer"><span>＋</span><strong>Crée ta première boutique</strong><small>Importe un produit ou pars d’une page vierge.</small></a>`}</section>
    </main></div>`;
}
